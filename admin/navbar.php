<div class="header-inner">
         <!-- BEGIN LOGO -->  
         <a class="navbar-brand" href="home_user.php"><img src="assets/img/logo4.png" alt="logo" width="148" height="53" class="img-responsive" />         </a>
...
echo '<img  src="data:image/jpg;base64,'.base64_encode($data). '" height="29" width="29" class="img-rounded" />';
								?>
              <span class="username"><?php echo $admin->fullname; ?></span>

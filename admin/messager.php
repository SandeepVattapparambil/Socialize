...
<head>
   <meta charset="utf-8" />
   <title>Socialize | Messager</title>
...
<body class="page-header-fixed">
      ...
      <div class="page-content">
         ...
         <div class="row">
            ...
            <ul class="nav nav-tabs">
                     <li class="active"><a>Messages and News</a></li>
               ...
               <div class="portlet ">
                  ...
                  <div class="portlet-body form">
                     <!-- BEGIN FORM-->
                     <form class="form-horizontal form-bordered" action="functions/add_message.php" method="post" enctype="multipart/form-data">
                        <div class="form-body">
                        <div class="form-group">
                              <label class="control-label col-md-3">Enter message or news title here !</label>
                              <div class="col-md-9">
                                 <input name="title" type="text" class="form-control" rows="6">
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="control-label col-md-3">Enter your message or news here !</label>
                              <div class="col-md-9">
                                 <textarea name="message" class="wysihtml5 form-control" rows="15"></textarea>
                              </div>
                           </div>
                        ...
                        <div class="form-body">
                           ...
                           <div class="form-group last">
                              <label class="control-label col-md-3">Upload image for your message.</label>
                              <div class="col-md-9">
                                 <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                       <img src="assets/img/search/img3.jpg" alt="" />
                                    </div>
   ...
   <?php
    if (isset($_GET['add_msg'])){
	        if($_GET['add_msg']==1) //Success
                {
                    echo '<script type="text/javascript">
                        toastr.success("Message has been added successfully");
                        </script>';
                }   
                else if($_GET['add_msg']==2) //Image size exceeded
                {
                    echo '<script type="text/javascript">
                        toastr.error("Image size should not exceed 1 MB");
                        </script>';
                } 
                else if($_GET['add_msg']==3) //Image format error
                {
                    echo '<script type="text/javascript">
                        toastr.error("Image format must be JPG");
                        </script>';
                }     
                else if($_GET['add_msg']==4) //Image upload failed
                {
                    echo '<script type="text/javascript">

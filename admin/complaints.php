...
<body class="page-header-fixed">
                        ...
                        <ul class="chats">
                            <?php
                              ...
                              <div class="message">
								 ...
								 <input type="hidden" id="comp_id" value="'.$complaint->id.'"/>
                                 <a class="btn btn-xs green">Accept <i class="icon-thumbs-up"></i></a>
                                 <a class="btn btn-xs red">Reject <i class="icon-thumbs-down"></i></a>
                                  </div>
                              </div>
                           </li>';
									}
   ...
   $('.btn').click(function () { 
   		$btn=$(this);
		$id=$btn.closest('li.in').find('#comp_id').val();
   		if($btn.attr('class')=='btn btn-xs green') //Accept button
   		{
				$.ajax({
				type: "POST",
				url: "functions/accept_complaint.php",
				data: { accept: "1", id: $id }
				})
				.done(function( msg ) { 
                                    $btn.closest('li.in').hide('fast'); 
                                    toastr.success('Complaint has been accepted');
                        });
   		} 
		if($btn.attr('class')=='btn btn-xs red') //Reject button
   		{
				...
				.done(function( msg ) { 
                                    $btn.closest('li.in').hide('fast');
                                    toastr.success('Complaint has been rejected');
                        });
   		} 
   });
   </script>

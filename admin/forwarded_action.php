           ...
           <div class="col-md-6 col-sm-6">
              ...
              <div class="portlet">
                  <div class="portlet-title line">
                     <div class="caption"><i class="icon-signin"></i>Forwarded Action List - Special Authority</div>
                     <div class="tools">
                     ...
                     <div class="scroller" style="height: 500px;" data-always-visible="1" data-rail-visible1="1">
                        <ul class="chats">
						   ...
						   $complaint=new Complaint(); 		
								$complaint_ids=$complaint->getComplaintsForwadedToSA();
								if ($complaint_ids == NULL) echo('<li class="in">No complaints have been forwarded to special authorities</li>');
                          ...
                          echo '<li class="in">
                              ...
                              <div class="message">
                                 ...
                                 <span class="datetime">'.time_gap($complaint->date_and_time).'</span>&nbsp;<span class="badge badge-info">Forwarded to Special Authority</span>
                                 <span class="body">
                                 '.$complaint->text.'
                                 </span>
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="portlet">
                  <div class="portlet-title line">
                     <div class="caption"><i class="icon-signin"></i>Forwarded Action List - Central Administrative Agency</div>
                     <div class="tools">
                        <a href="" class="collapse"></a>
                        <a href="" class="reload"></a>
                        <a href="" class="remove"></a>
                  ...
                  <div class="portlet-body" id="chats">
                     ...
                     <?php
						   $complaint=new Complaint(); 		
								$complaint_ids=$complaint->getComplaintsForwadedToCA();;
								if ($complaint_ids == NULL) echo('<li class="in">No complaints have been forwarded to central administrative agency</li>');
								foreach($complaint_ids as $element){
									$complaint->getComplaint($element);
									if($complaint->la_id=$admin->id)
									{
                          ...
                          echo '<li class="in">
                              ...
                              <div class="message">
                                 <span class="arrow"></span>
                                 <span class="name">'.$comp_user->fullname.'</span>
                                 <span class="datetime">'.time_gap($complaint->date_and_time).'</span>&nbsp;<span class="badge badge-default">Forwarded to Central Administrative Agency</span>
                                 <span class="body">
                                 '.$complaint->text.'
                                 </span>
                                 <button data-original-title="Solve this Complaint" data-placement="bottom" class="btn btn-xs default tooltips"><i class=" icon-ok"></i>Clear</button>&nbsp;

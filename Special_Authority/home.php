                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 <div class="col-md-8 profile-info">
                                    <h1><?php echo $sa->sa_name; ?></h1>
                                    <ul class="list-inline">
                                       <li><i class="icon-map-marker"></i> <?php echo $sa->sa_email; ?> </li><br/>
                                       <!--<li><i class="icon-calendar"></i> Voters ID</li><br/>
                                       <li><i class="icon-briefcase"></i> LAI</li><br/>-->
                                       <?php if($sa->sa_mob_no!=0){echo "<li><i class=\"icon-star\"></i> $sa->sa_mob_no</li><br/>";}
...
<?php
	...
	$complaints=$complaint->getLatestComplaintList($sa->id);
	if(!empty($complaints)){

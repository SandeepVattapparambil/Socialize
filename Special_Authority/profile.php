                                 ...
                                 <div id="tab_1-1" class="tab-pane active">
                                    <form name="edit_form" role="form" action="functions/profile_edit.php" method="post">
                                       <div class="form-group">
                                          ...
                                          <input name="name" type="text" placeholder="Name" class="form-control" value="<?php echo $sa->sa_name;?>" />
                                       </div>

                                       <div class="form-group">
                                          <label class="control-label">Mobile Number</label>
                                          <input name="mobile" type="text" placeholder="Mobile Number" class="form-control"  value="<?php echo $sa->sa_mob_no;?>"/>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label">Email ID</label>
                                          <input name="email" type="text" placeholder="someone@something.com" class="form-control" value="<?php echo $sa->sa_email;?>" />
                                       </div>

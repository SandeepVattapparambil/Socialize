...
<head>
   <meta charset="utf-8" />
   <title>Socialize | Special Authority </title>
           ...
           <div class="col-md-9 col-sm-9">
              ...
              <div class="portlet">
                  <div class="portlet-title line">
                     <div class="caption"><i class="icon-comments"></i>Solved Complaints</div>
                     <div class="tools">
...
<?php
	...
	$complaints=$complaint->getClearedComplaintList($sa->id);
	       $sl_no=0;
					  ...
					  echo '<!--chat in strts here-->
                           <li class="in">
                              ...
                              <div class="message">
                                 ...
                                 <button  id="responce-btn-'.$sl_no.'" class="btn btn-xs default tooltips" data-placement="bottom" data-original-title="'.$complaint->getComplaintResponceCount().' Comments"><i class=" icon-adjust"></i></button>&nbsp;
                           ...
                           <div id="panel" class="response-panel">
